...
# NORM_VALIDITY_COVERAGE / PRECEPT_LEVEL_NORMATIVE_BASIS
...
# M8-D: conditional semantics + operational/dynamic restrictions
REASON_MISSING_FACT = "MISSING_FACT"
REASON_CONDITIONAL_UNVERIFIED = "CONDITIONAL_UNVERIFIED_REQUIREMENTS"
REASON_OPERATIONAL_BLOCK = "OPERATIONAL_RESTRICTION_ACTIVE"
# M8-E: spatial ambiguity (preregistered boundary policy)
REASON_BOUNDARY_AMBIGUOUS = "BOUNDARY_AMBIGUOUS"
# M8-D2: outcome depends on caller-declared facts the system cannot verify
REASON_DEPENDS_DECLARED_FACTS = "DEPENDS_ON_DECLARED_FACTS"
